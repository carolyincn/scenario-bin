...
import binascii
from util import *
read_path_in = "pipe-33"
read_path_out = "pipe-res-33"
CHAR_SIZE = 1
...
while True:
    ...
    #     # print("nodata")
        ...
        #     else:
        #         if evil.time - evillist[-1][-1].time < 1:
        #             pass


        # print(' '.join([bin(ord(c)).replace('0b', '') for c in msglen]))
        # print(type(msglen), ord(msglen))
    # # f.write(str(data))
    # # print(data, end = '')
    # # data = binascii.b2a_uu(data)
